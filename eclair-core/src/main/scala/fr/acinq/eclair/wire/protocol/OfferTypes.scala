...
import fr.acinq.eclair.{Bolt12Feature, CltvExpiryDelta, Feature, Features, InvoiceFeature, MilliSatoshi, TimestampSecond, UInt64, randomBytes32}
...
object OfferTypes {
  ...
  case class InvoiceCode(code: String) extends InvoiceTlv
