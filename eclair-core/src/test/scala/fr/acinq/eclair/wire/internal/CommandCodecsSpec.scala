...
class CommandCodecsSpec extends AnyFunSuite {
  ...
  test("backward compatibility") {
    ...
    val testCases = Map(
      ...
      hex"0002 000000000000002ae4927c04913251b44d0a3a8e57ded746fee80ff3b424e70dad2a1428eeba86cb01c8" -> CMD_FAIL_MALFORMED_HTLC(42, data32, 456, None, commit = false, None),
    )
